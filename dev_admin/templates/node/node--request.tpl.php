...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> task"<?php print $attributes; ?>>
  <div class="control mb30">
    ...
    <?php endif; ?>
    <?php if (!empty($content['field_request_client'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_request_client']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_request_manager'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_request_manager']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_request_author'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_request_author']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_request_executor'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_request_executor']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_request_courier'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_request_courier']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_task_status'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_task_status']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_task_priority'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_task_priority']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_user_department'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_user_department']); ?></div>
    <?php endif; ?>

    <?php if (!empty($content['field_request_type'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_request_type']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_task'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_task']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_request_status'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_request_status']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['j_crm_order_status'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['j_crm_order_status']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_order_product'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_order_product']); ?></div>
    <?php endif; ?>
  </div>
