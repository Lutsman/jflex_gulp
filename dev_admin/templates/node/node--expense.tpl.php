...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> task"<?php print $attributes; ?>>
  <div class="control mb30">
    <?php if (!empty($content['field_expense_execute'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_expense_execute']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_expense_category'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_expense_category']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_expense_method'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_expense_method']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_expense_company'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_expense_company']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_expense_status'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_expense_status']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_expense_amount'])): ?>
      <div class="fl w100"><?php print drupal_render($content['field_expense_amount']); ?></div>
    <?php endif; ?>
  </div>
  ...
  <?php if (!empty($content['field_expense_fc'])): ?>
    <div class="control mb30">
      <div class="expense items"><?php print drupal_render($content['field_expense_fc']); ?></div>
    </div>
  <?php endif; ?>
