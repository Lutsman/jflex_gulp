...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> task"<?php print $attributes; ?>>
  <div class="control mb30">
    ...
    <?php endif; ?>
    <?php if (!empty($content['field_task_client'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_task_client']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_task_manager'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_task_manager']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_task_author'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_task_author']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_task_executor'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_task_executor']); ?></div>
    <?php endif; ?>
    <?php if (!empty($content['field_task_courier'])): ?>
      <div class="fl mr20"><?php print drupal_render($content['field_task_courier']); ?></div>
    <?php endif; ?>
    ...
    <?php if (!empty($content['field_user_department'])): ?>
      <div class="fl"><?php print drupal_render($content['field_user_department']); ?></div>
    <?php endif; ?>
  </div>
